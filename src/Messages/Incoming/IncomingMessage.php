...
class IncomingMessage
{
     ...
     * @return string
     */
    public function getConversationIdentifier($token = false)
    {
        $key = 'conversation';
        ...
        $key .= '-'.sha1($this->getSender()).'-'.sha1($this->getRecipient());
     ...
     * @return string
     */
    public function getOriginatedConversationIdentifier($token = false)
    {
        $key = 'conversation';
